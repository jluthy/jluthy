...
Building pipelines and ML tools at the intersection of immunology and data engineering.

**Current focus:** Flow cytometry · Imaging cytometry · scRNA-seq · TCR repertoire analysis · Applied ML for life sciences
...
**Domains:** Flow cytometry · scRNA-seq · TCR analysis · ML/ensemble methods · S4 OOP · FlowJo plugin development  
**Tools:** Tidyverse · ggplot2 · scikit-learn · pandas · Bioconductor

---

### Open to

Senior and principal-level remote roles in computational immunology, translational bioinformatics, and applied ML for life sciences. Also available for contract/consulting engagements via [Upwork](https://www.upwork.com).

Kailua-Kona, Hawaii · Remote-first
